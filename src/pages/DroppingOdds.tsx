  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-tr from-slate-800 via-slate-700 to-slate-600 rounded-3xl p-5 text-white shadow-xl hover:shadow-2xl transition-all duration-400 hover:rotate-1 relative overflow-hidden">
          <div className="absolute -top-4 -right-4 w-20 h-20 bg-blue-500/20 rounded-full blur-xl"></div>
          <div className="relative z-10">
            <div className="text-center">
              <h3 className="font-bold text-lg mb-2">BETINASIA</h3>
              <p className="text-sm opacity-90 mb-3">Get 100% First Deposit Bonus!</p>
              <button className="w-full bg-blue-500 text-white py-3 rounded-2xl font-semibold hover:bg-blue-600 transition-all duration-300 transform hover:scale-105">
                CLAIM OFFER
              </button>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-bl from-amber-500 via-orange-500 to-red-500 rounded-3xl p-5 text-white shadow-xl hover:shadow-2xl transition-all duration-400 hover:-rotate-1 relative overflow-hidden">
          <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-yellow-500/20 rounded-full blur-xl"></div>
          <div className="relative z-10">
            <div className="text-center">
              <h3 className="font-bold text-lg mb-2">bet-at-home</h3>
              <p className="text-sm opacity-90 mb-3">Get a 300€ Welcome bonus!</p>
              <button className="w-full bg-white/20 backdrop-blur-sm text-white py-3 rounded-2xl font-semibold hover:bg-white/30 transition-all duration-300 transform hover:scale-105 border border-white/30">
                CLAIM OFFER
              </button>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-tl from-violet-600 via-purple-600 to-indigo-600 rounded-3xl p-5 text-white shadow-xl hover:shadow-2xl transition-all duration-400 hover:rotate-1 relative overflow-hidden">
          <div className="absolute -top-4 -left-4 w-20 h-20 bg-pink-500/20 rounded-full blur-xl"></div>
          <div className="relative z-10">
            <div className="text-center">
              <h3 className="font-bold text-lg mb-2">bets.io</h3>
              <p className="text-sm opacity-90 mb-3">First Deposit Sport Bonus</p>
              <button className="w-full bg-white/20 backdrop-blur-sm text-white py-3 rounded-2xl font-semibold hover:bg-white/30 transition-all duration-300 transform hover:scale-105 border border-white/30">
                CLAIM OFFER
              </button>
            </div>
