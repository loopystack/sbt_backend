...
export default function HeroSection() {
  ...
  return (
    <section className="mb-8">
      {/* Hero Content */}
      <div className="bg-gradient-to-br from-surface to-bg border border-border rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 relative">
        ...
        <div className="flex-1 lg:ml-60">
          <div className="text-center mb-6 sm:mb-8 p-3">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-text mb-4">
              Find the Best Betting Odds
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-muted max-w-2xl mx-auto px-2">
          ...
          <div className="max-w-2xl mx-auto mb-6 sm:mb-8 px-2">
            <div className="relative">
              <input
                ...
                className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-bg border border-border rounded-xl text-text placeholder-muted focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all text-sm sm:text-base"
              />
              <button className="absolute right-2 top-2 px-4 sm:px-6 py-1.5 sm:py-2 bg-accent text-white font-semibold rounded-lg hover:bg-accent/90 transition-colors text-sm">
                Search
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-2">
            <div className="text-center">
              ...
              <div className="text-sm sm:text-base text-muted">Bookmakers</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-accent mb-2">20+</div>
              <div className="text-sm sm:text-base text-muted">Sports</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-accent mb-2">1000+</div>
              <div className="text-sm sm:text-base text-muted">Daily Matches</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Featured Matches */}
      <div className="mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-text mb-4 px-2">Featured Matches</h2>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-base sm:text-lg font-bold text-accent">{match.time}</div>
                </div>
              </div>
              
              {/* Teams */}
              <h3 className="font-bold text-text text-base sm:text-lg mb-2 sm:mb-3 leading-tight line-clamp-2">
                {match.teams}
              </h3>
              
              {/* League */}
              <div className="text-xs sm:text-sm text-muted mb-3 sm:mb-4">{match.league}</div>
              ...
              {/* Action */}
              <button className="w-full px-3 sm:px-4 py-2 bg-accent text-white text-xs sm:text-sm font-semibold rounded-lg hover:bg-accent/90 transition-colors group-hover:scale-105">
                Compare Odds
              </button>
            </div>
          ))}
