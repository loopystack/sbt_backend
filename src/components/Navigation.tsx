      ...
      <div className="w-full px-4">
        ...
        <div className="flex items-center h-16 py-3">
          ...
          <div className="ml-10 flex-1 flex items-center justify-center">
            <div className="flex items-center gap-2  backdrop-blur-sm rounded-2xl p-2 ">
              {navigationTabs.map((tab) => (
                <button
                  key={tab.id}
                  onClick={() => handleTabClick(tab.id)}
                  className={`flex items-center gap-3 px-5 py-3.5 rounded-xl transition-all duration-300 font-medium text-sm relative overflow-hidden group ${
                    activeTab === tab.id
                ...
                >
                  ...
                  <span className="relative z-10 font-bold tracking-wide text-base">{tab.name}</span>
                  {activeTab === tab.id && (
        ...
        <div className="border-t border-border/30  from-bg/50 to-surface/50">
          <div className="flex items-center justify-center gap-2 overflow-x-auto scrollbar-hide py-4">
            {/* Favorites */}
            <button className="flex items-center gap-3 px-5 py-3.5 rounded-xl whitespace-nowrap transition-all duration-300 text-muted hover:text-text hover:bg-gradient-to-r hover:from-yellow-400/20 hover:to-orange-400/20 hover:scale-105 group border border-transparent hover:border-yellow-400/30">
              <span className="text-lg group-hover:scale-110 transition-transform duration-200">⭐</span>
              <span className="font-bold tracking-wide text-base">Favorites</span>
            ...
            {sports.map((sport) => (
              <button
                ...
                className={`flex items-center gap-3 px-5 py-3.5 rounded-xl whitespace-nowrap transition-all duration-300 relative overflow-hidden group ${
              ...
              >
                ...
                <span className="font-bold tracking-wide text-base relative z-10">{sport.name}</span>
                {activeSport === sport.name && (
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 px-5 py-3.5 rounded-xl whitespace-nowrap transition-all duration-300 text-muted hover:text-text hover:bg-gradient-to-r hover:from-purple-400/20 hover:to-indigo-400/20 hover:scale-105 group border border-transparent hover:border-purple-400/30"
              >
                <span className="font-bold tracking-wide text-base">More</span>
